        ...
        <table class="w-full table-fixed border-collapse border border-slate-400">
            ...
            @foreach($status as $item)
                <tr>
                                ...
                                <div class="w-2/5 mx-auto mt-20 relative -top-full bg-white p-5 rounded-lg">
                                    ...
                                    <form action="{{ route('admin.status.update') }}" method="POST">
                                        ...
                                        <input
                                            ...
                                            readonly
                                        >
                                        <label for="name" class="block text-sm font-semibold leading-6 text-gray-900 mt-2">ステータス</label>
                                        <input
                                            type="text"
                                            name="name"
                                            id="name"
                    ...
                    <td class="border border-slate-500 px-3">
                        <!-- todo:削除モーダルを作成 -->
                        <button class="block rounded-lg rounded-full bg-red-500 text-white px-4 w-2/5 mx-auto text-center">削除</button>
                    </td>
                </tr>
            @endforeach
            </tbody>
